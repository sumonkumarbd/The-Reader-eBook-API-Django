...
WHITENOISE_USE_FINDERS = True  # For static files

# Trick to serve /media/ files
...
JAZZMIN_SETTINGS ={
    ...
    # "site_icon": "/media/admin-interface/logo/logo_png.png",

    # Welcome text on the login screen
    "welcome_sign": "Welcome to The Reader E-Book System",

    # Copyright on the footer
    "copyright": "The Reader E-Book Management System",
    ...
    "user_avatar": "/admin-interface/user/formal.jpg",
